...
{
#ifdef __linux__
    SDL_SetHint("SDL_APP_ID", "io.github.Jenish094.GTA4Recomp");
#endif
    ...
    s_pWindow = SDL_CreateWindow("GTA4Recomp", s_x, s_y, s_width, s_height, GetWindowFlags());
