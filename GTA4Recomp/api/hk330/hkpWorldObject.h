...
namespace hk330
{
    ...
    public:
        ...
        FERNANDO_INSERT_PADDING(0x0C);
        hkpLinkedCollidable m_collidable;
        FERNANDO_INSERT_PADDING(8);
        xpointer<const char> m_name;
        hkArray<hkpProperty> m_properties;
    };

    FERNANDO_ASSERT_OFFSETOF(hkpWorldObject, m_world, 0x08);
    FERNANDO_ASSERT_OFFSETOF(hkpWorldObject, m_userData, 0x0C);
    FERNANDO_ASSERT_OFFSETOF(hkpWorldObject, m_collidable, 0x1C);
    FERNANDO_ASSERT_OFFSETOF(hkpWorldObject, m_name, 0x7C);
    FERNANDO_ASSERT_OFFSETOF(hkpWorldObject, m_properties, 0x80);
}
