...
namespace hk330
{
    ...
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_simulation, 0x08);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_gravity, 0x20);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_fixedIsland, 0x30);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_fixedRigidBody, 0x34);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_activeSimulationIslands, 0x38);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_inactiveSimulationIslands, 0x44);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_dirtySimulationIslands, 0x50);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_maintenanceMgr, 0x5C);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_memoryWatchDog, 0x60);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_broadPhase, 0x64);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_broadPhaseDispatcher, 0x68);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_phantomBroadPhaseListener, 0x6C);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_entityEntityBroadPhaseListener, 0x70);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_broadPhaseBorderListener, 0x74);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_collisionInput, 0x78);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_collisionFilter, 0x7C);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_collisionDispatcher, 0x80);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_pendingOperations, 0x84);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_pendingOperationsCount, 0x88);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_criticalOperationsLockCount, 0x8C);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_criticalOperationsLockCountForPhantoms, 0x90);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_blockExecutingPendingOperations, 0x94);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_criticalOperationsAllowed, 0x95);
    FERNANDO_ASSERT_OFFSETOF(hkpWorld, m_phantoms, 0xC4);
}
