...
namespace VFS
{
    ...
    void ResetPathMappings()
    {
        ...
        // map xb360 paths to extracted
        
        // common.rpf/shaders/fxl_final to common/shaders/fxl_final
        ...
        // common.rpf to common/, xbox360.rpf to xbox360/, audio.rpf to audio/
