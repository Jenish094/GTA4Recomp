...
## /app.cpp
Added framehooks for GTA4

## /exports.cpp
had to reimplement gta4's audio system since it uses RAGE

## /main.cpp
readapted the file towards GTA4 and took into account the edits made due to the RAGE engine
